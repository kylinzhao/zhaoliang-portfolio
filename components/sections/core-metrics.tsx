...
const metrics = [
  { icon: "📉", value: "62%", label: "成本下降", description: "月均节约7.5万元" },
  { icon: "📈", value: "72万", label: "SEO收录", description: "独立站页面收录" },
  { icon: "👥", value: "27人", label: "团队规模", description: "商家服务大前端" },
  { icon: "🤖", value: "184", label: "AI CR", description: "项目接入AI Code Review" },
];
